...
// TODO: rewrite this as a usable module?
// pass in input/output params
// or at allow me to select which function to use.


// convert file of mispellings in a weird format
// into rought json
var templatize = function(textfile, tagfileout) {

  // TODO: if no tagfileout, use textfilename + some tempstring or whatsis


  tagfileout = tagfileout || textfile + '.tmpl';
  ...
  fs.readFile(textfile, 'utf8', function(err, data) {
    ...
    fs.writeFile(tagfileout, posed.join('\n'));
